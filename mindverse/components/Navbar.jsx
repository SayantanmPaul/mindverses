...
const Navbar = () => (
  ...
  >
    ...
    <div
      className="2xl:max-w-[1280px] w-full
     mx-auto flex justify-between items-center gap-8"
    >
      <button className=" object-contain h-[24px] w-[24px]">
      ...
      <h2 className=" font-extrabold text-[24px] leading-[30px] text-white uppercase">Mindverses</h2>
      <button className=" object-contain h-[24px] w-[24px]">
